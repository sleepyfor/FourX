...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    private GuiButton field_175357_i, twitchButton;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(twitchButton = new GuiButton(107, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, "\247lRemoved for performance"));
