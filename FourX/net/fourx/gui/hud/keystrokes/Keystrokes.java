...
public class Keystrokes {
    ...
    public static void drawKeystrokes(float x, float y){
        ...
        RenderingUtils.drawBorderedRectangle(x + 22, y, x + 42, y + 20, 1, new Color((int) opacityF, (int) opacityF, (int) opacityF, 90).getRGB(), color);
        RenderingUtils.drawBorderedRectangle(x, y + 22, x + 20, y + 42, 1, new Color((int) opacityL, (int) opacityL, (int) opacityL, 90).getRGB(), color);
        RenderingUtils.drawBorderedRectangle(x + 22, y + 22, x + 42, y + 42, 1, new Color((int) opacityB, (int) opacityB, (int) opacityB, 90).getRGB(), color);
        RenderingUtils.drawBorderedRectangle(x + 44, y + 22, x + 64, y + 42, 1, new Color((int) opacityR, (int) opacityR, (int) opacityR, 90).getRGB(), color);
